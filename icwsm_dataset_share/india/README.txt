...
1. misinfo: Contains 897 images which were labelled as misinformation either using automated matching to fact checking sites or by professional journalists.
